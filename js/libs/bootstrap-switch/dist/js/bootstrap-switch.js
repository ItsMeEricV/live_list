        ...
        return this.$label.on({
          ...
          "mouseup.bootstrapSwitch touchend.bootstrapSwitch": (function(_this) {
            return function(e) {
              ...
              e.preventDefault();
              _this.drag = false;
              //commented out because it breaks the switch if the mouse is inside the switch area when mouseup occurs. By commenting this out it means that the mouse MUST be inside the switch area for the switch to trigger. if the mouse is outside then the switch will not trigger.
